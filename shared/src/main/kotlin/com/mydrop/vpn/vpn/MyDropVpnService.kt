...
class MyDropVpnService : VpnService() {
    ...
    private fun buildNotification(): AndroidNotification {
        // Both the phone and TV applications use this service from the shared module. Resolve the
        // launcher belonging to the installed package instead of coupling the notification to the
        // phone-only MainActivity.
